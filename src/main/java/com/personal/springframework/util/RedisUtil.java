...
public class RedisUtil {
    ...
    /**
     * @MethodName: lGetListSize
     * @Description: 取出list中最左的值
     * @Param: [key]
     * @Return: long
     * @Author: anshaojun
     * @Date: 2020-06-09 18:08
     **/
    public Object lPotList(String key) {
        try {
     ...
     **/
    public Object potSet(String key) {
        try {
    ...
    public Set keys(String parten) {
        return redisTemplate.keys(parten);
    }
